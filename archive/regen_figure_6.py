...
p_matrix = {
    ...
    ("RAG+Exomiser", "Phenotype-only"): 0.0,
...
plt.tight_layout()
plt.savefig("figure6_mcnemar_heatmap_8approaches.png", dpi=300)
print("Saved figure6_mcnemar_heatmap_8approaches.png")