...
RESULTS_DIR = Path("llm_results_exomiser_assisted_sonnet")
MODEL = "claude-sonnet-4-6"

TOP_N_EXOMISER    = 5  # number of Exomiser genes to feed into prompt
NUM_GENES         = 5  # number of genes Claude should return
# ──────────────────────────────────────────────────────────────────────────────
...
Prioritise genes from the Exomiser list where they fit the phenotype, but you may include genes not in the Exomiser list if strongly indicated.
...
Return exactly {NUM_GENES} candidate genes ranked by your own clinical reasoning, prioritising genes from the Exomiser list where they fit the phenotype. Use real HGNC gene symbols only."""
